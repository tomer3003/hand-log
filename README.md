...
- **Cards** — click any slot, on the felt or in a pod, to pick a card. Cards already in play
  are greyed out. The deck is four-coloured: spades black, hearts red, diamonds blue, clubs
  green, so a flush is obvious at a glance. The **×** beside a player's cards clears both at once; it only appears when
